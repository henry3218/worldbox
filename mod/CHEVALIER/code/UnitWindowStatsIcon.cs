...
namespace Chevalier.code
{
    public class UnitWindowStatsIcon
    {
        ...
        public static void OnEnable(UnitWindow window, Actor actor) {
            ...
            window.setIconValue("Chevalier", actor.GetChevalier());
            window.setIconValue("Comprehension", actor.GetComprehension());
            window.showInfo();
        }
        ...
        public static StatsIconData[] StatsIconDatas = {
            new ("Chevalier", "Chevalier.png",true),
            new ("Comprehension", "Comprehension.png",true),
        };
